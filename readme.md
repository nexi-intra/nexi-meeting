...
2. **Create a New Repository**:
   ...
   - Use the master template repository: [nexi-meeting](https://github.com/nexi-intra/nexi-meeting)
...
- Search and replace "nexi-intra/nexi-meeting" with your repos name "owner/repo"
